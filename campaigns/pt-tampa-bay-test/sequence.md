# Campaign: PT Clinics — Tampa Bay Test
**Target:** Small PT clinics, Tampa Bay / St Pete / Clearwater / Largo, FL  
**From:** vito@argusreach.com  
**Signed as:** Vito, ArgusReach  
**Goal:** Systems test — validate full workflow end-to-end  
**Volume:** ~20–30 prospects  
**CTA:** 15-min call → https://calendly.com/vito-argusreach/30min  
**Created:** 2026-03-13

---

## ICP
- Physical therapy clinics, small (1–10 therapists)
- Owner-operated or owner is clinical director
- Tampa Bay metro: Tampa, St Pete, Clearwater, Largo, Dunedin, Safety Harbor
- Pain: referral pipeline from physicians — inconsistent, relationship-dependent, no system
- NOT: hospital-owned PT departments, large franchise chains (ATI, Athletico), VA/military
...
## Notes
- Personalization variables: {{first_name}}, {{company}}, {{calendly_link}}
- If a prospect replies at any point → stop sequence immediately (Instantly: stop_on_reply = true)
- Positive/question replies → Gob drafts response, Vito approves before sending
- Negative/unsubscribe → add to DNC, no follow-up
